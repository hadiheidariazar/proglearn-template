...
export default function Landing() {
    ...
    return (
        <div>
            <section className="landing text-center text-white d-grid align-items-center">
                <div className="container-fluid">
                    <h1 className="landing__title fw-bold">
                        <Typewriter
                            onInit={(typeWriter) => {
                                typeWriter
                                    ...
                                    .pauseFor(2000)
                                    .deleteAll()
                                    .typeString('پروگ لرن - آکادمی خصوصی آموزش برنامه نویسی')
                                    .start()
                                    .pauseFor(2000)
                            }}
                    ...
                    <h2 className="landing__subtitle mt-3 mt-lg-1">
                        با آکادمی پروگ لرن، برنامه نویسی رو با خیال راحت یاد بگیر و پیشرفت کن.
                    </h2>
                    <div className="landing__searchbar position-relative mx-auto mt-5 mb-0 mb-lg-5">
                        <input
                            type="text"
                            className="landing__searchbar-input w-100 rounded-4"
                            placeholder="چی دوست داری یاد بگیری ..."
                        />
                        <button className="landing__searchbar-btn bg-main-color p-3 p-md-4 position-absolute">
                            <BsSearch className='landing__searchbar-icon text-white' />
                        </button>
                    </div>
                    <div className="landing-status d-none d-lg-flex justify-content-evenly align-items-center">
                        <div className="landing-status__item d-flex align-items-center justify-content-center">
                            <svg
                            ...
                            <LandingCounter count={1542} MS={1} />
                            <span className="landing-status__text mt-2">
                                کاربر توی پروگ لرن ثبت نام کردن
                            </span>
                        </div>
                        ...
                        <div className="landing-status__item d-flex align-items-center justify-content-center">
                            ...
                            <LandingCounter count={40} MS={40} />
                            <span className="landing-status__text mt-2">دوره آموزشی داریم</span>
                        </div>
                        ...
                        <div className="landing-status__item d-flex align-items-center justify-content-center">
                            ...
                            <LandingCounter count={213} MS={5} />
                            <span className="landing-status__text mt-2">ساعت آموزش تولید کردیم</span>
                        </div>
                    </div>
                </div>
            </section>
